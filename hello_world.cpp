...
// This is a great overall article
//
// See: https://blogs.msdn.microsoft.com/vcblog/2016/03/31/cc-extension-for-visual-studio-code/

// Problem: Configuring `c_cpp_properties.json`
// --------------------------------------------
//
// See: https://github.com/Microsoft/vscode-cpptools/blob/master/Documentation/LanguageServer/c_cpp_properties.json.md

// Problem: Configuring VS Code User / Workspace Settings `settings.json`
// ----------------------------------------------------------------------
//
...
// which provides Fuzzy intellisense which removes the error squiggles.
// The solution was to set "C_Cpp.intelliSenseEngineFallback": "Disabled"
// For some reason this does not seem to be required in Mac OS.  

// Problem: Compile / Link Errors on Mac OS
// ----------------------------------------------
//
...
// 
// See: https://stackoverflow.com/questions/8034568/undefined-symbols-for-architecture-x86-64-which-architecture-should-i-use

// Problem: Configuring launch.json for C/C++ debugging
// ----------------------------------------------------
...
//
// See: https://www.quora.com/Why-does-the-gcc-command-on-MacOS-execute-clang
// See: https://github.com/Microsoft/vscode-cpptools/blob/master/launch.md

// Problem: Compile the Current File
// ---------------------------------
//
...
//
// See: https://github.com/Microsoft/vscode/issues/1104
